...
export default function HijriCalendar() {
  ...
  if (loading && calendarData.length === 0) {
    return (
      <div className="flex items-center justify-center h-full min-h-[50vh] bg-[var(--color-bg)]">
  ...
  return (
    <div
      className="max-w-md mx-auto p-4 space-y-6 pb-24 min-h-screen bg-[var(--color-bg)]"
      dir="rtl"
    >
      {/* Header 3D */}
      <motion.div
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-[var(--color-text-muted)] text-sm font-medium">مواقيت ومناسبات</p>
        </div>
      </motion.div>
      ...
      >
        <div className="grid grid-cols-7 gap-2 mb-2 text-center">
          {["ح", "ن", "ث", "ر", "خ", "ج", "س"].map((day, i) => (
            <div key={i} className="text-xs font-bold text-[var(--color-text-muted)]">
              {day}
            </div>
          ))}
        </div>
          ...
          {calendarData.map((day, i) => {
            ...
            return (
              ...
              >
                ...
                {event && !isToday && (
                  <div className="absolute top-1 right-1 w-1.5 h-1.5 bg-[var(--color-primary)] rounded-full shadow-[0_0_5px_rgba(212,175,55,0.8)]"></div>
                )}
              </motion.div>
            );
          })}
      ...
      <motion.div
        ...
        className="space-y-3"
      >
        <h3 className="font-bold text-[var(--color-primary-light)] px-2 font-serif">مناسبات الشهر</h3>
        ...
        {calendarData.filter((day) =>
          ...
          <div className="text-center text-[var(--color-text-muted)] text-sm py-4 bg-[var(--color-surface)] rounded-2xl border border-white/5 shadow-inner">
