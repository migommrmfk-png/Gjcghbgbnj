...
export const DEFAULT_SURAHS: Surah[] = [
  ...
  { number: 70, name: "المعارج", englishName: "Al-Ma'arij", englishNameTranslation: "The Ascent Ways", numberOfAyahs: 44, revelationType: "Meccan" },
  ...
  { number: 95, name: "التين", englishName: "At-Tin", englishNameTranslation: "La Higuera", numberOfAyahs: 8, revelationType: "Meccan" },
  ...
  { number: 107, name: "الماعون", englishName: "Al-Ma'un", englishNameTranslation: "Acts of Kindness", numberOfAyahs: 7, revelationType: "Meccan" },
